  ...
  btn.addEventListener("click", function() {
    ...
    fetch(apiUrl)
      .then((response) => {
        ...
        contentOutput.innerHTML = `<div class="content  p-2 bg-blue text-center row justify-content-center col-12">
              <p class="col-10 m-0 fw-medium text-center zona">
                  <span><i class="fa-solid fa-location-dot"></i></span>
                  <span class="outKota">${kota}</span>, <span class="outProvinsi">${provinsi}</span>
                </p>
                    <p class="waktu">${waktu}</p>
               <div class="row col-12 justify-content-center informasi-suhu">
                   <div class="suhu-sekarang col-12">${suhuC}°</div>
                 <div class="col-6 d-flex justify-content-end flex-column">
                   <p class="align-text-bottom fw-medium keterangan-suhu">${cuaca}</p>
                 
                 </div>
                 <div class="col-6 row">
                       <div class=" p-0 icon-suhu">
                       <img class="" id="weatherIcon" src="https:${weatherIconUrl}" alt="Weather Icon" /></div>
                 </div>
                 
                 
               </div>
               <div class="informasi-detail mt-2 mb-2 pt-2 row justify-content-center align-items-center col-11">
                 <div class="col-4 p-0 informasi-suhu">
